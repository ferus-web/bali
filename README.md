...
As of 10th of September, 2024, Bali can successfully run 1.23% of the entire Test262 suite. There's a lot of work to be done here, so don't shy away from sending in PRs. ;)
